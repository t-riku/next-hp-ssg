    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs mt-2 text-gray-600">Fujisawa city</p>
          <p className="font-bold mt-3">E-mail</p>
          <p className="text-xs mt-2 text-gray-600">dingariku@icloud.com</p>
          <p className="font-bold mt-3">Phone</p>
          <p className="text-xs mt-2 text-gray-600">080-9800-1264</p>
        </div>
